...
export default function WeltkochenApp() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_#fffaf0_0%,_#f7edda_42%,_#efe0c7_100%)] pb-28 text-stone-900 md:pb-0" style={{ fontFamily: "ui-rounded, system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
      ...
      <div className="fixed inset-x-0 bottom-0 z-[120] px-3 pb-[max(.55rem,env(safe-area-inset-bottom))] md:hidden">
        <nav className="mx-auto max-w-lg overflow-hidden rounded-[1.55rem] border border-stone-200 bg-[#fffdf8] shadow-[0_12px_32px_rgba(55,42,25,.18)]">
